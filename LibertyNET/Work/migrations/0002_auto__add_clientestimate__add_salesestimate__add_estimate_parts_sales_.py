...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Work_estimate_parts_client', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('estimate_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Work.ClientEstimate'])),
        ))
    ...
    models = {
        ...
        u'Work.estimate_parts_client': {
            ...
            'estimate_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Work.ClientEstimate']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
