...
//        }
//    }
//    document.getElementById("id_street").value = addressInfo[0] + ' ' + addressInfo[1];
//    document.getElementById("id_zip_code").value = addressInfo[4];
//
//    if (document.getElementById("id_city")){
//        document.getElementById("id_city").value = addressInfo[2];
//    } else {
//        document.getElementById("id_city").value = addressInfo[2];
//    }
//
...
//        if (state_worker.options[i].value == addressInfo[3]) {
